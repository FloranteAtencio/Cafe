...
CREATE TABLE "order_items" (
  ...
  "quantiity" NUMBER,
  "adds_on" NUMBER NOT NULL,
  CONSTRAINT "FK_order_items_adds_on"
    FOREIGN KEY ("adds_on")
      REFERENCES "adds_on"("adds_on_id")
);

CREATE TABLE "order_count" (
  "order_count" NUMBER DEFAULT 1 NOT NULL CHECK ( "order_count" > 0),
  "order_date" DATE DEFAULT SYSDATE NOT NULL,
  CONSTRAINT "FK_order_count_order_count"
...
CREATE TABLE "details" (
  ...
  CONSTRAINT "FK_Details_payment_id"
...
CREATE TABLE "attachment" (
  ...
  CONSTRAINT "FK_Attachment_attachment_id"
...
CREATE TABLE "per_single_serving" (
  ...
  "amount" NUMBER(5,2) NOT NULL,
  "current_inventory_id" NUMBER NOT NULL,
  CONSTRAINT "FK_per_single_serving_menu_id"
    FOREIGN KEY ("menu_id")
      REFERENCES "menu"("menu_id"),
  CONSTRAINT "FK_per_single_serving_current_inventory_id"
    FOREIGN KEY ("current_inventory_id")
      REFERENCES "current_inventory"("current_inventory_id"),
  CONSTRAINT "FK_per_single_serving_current_inventory_id"
    FOREIGN KEY ("current_inventory_id")
      REFERENCES "adds_on"("current_inventory_id")
);
...
CREATE TABLE "inventory_transaction" (
  ...
  CONSTRAINT "FK_inventory_transaction_current_inventory_id"
    FOREIGN KEY ("current_inventory_id")
      REFERENCES "current_inventory"("current_inventory_id")
);
